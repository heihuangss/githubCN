const allData = [
  ...
  [`Cancel changes`, `取消更改`],
  [`Commit changes...`, `提交更改...`],
  [`Draft a new release`, `起草新版本`],
  [`Find a releese`, `查找版本`],
  [`Assets`, `资源`],
  [`Source code`, `源代码`],
  [`Compare`, `对比`],
  [`Choose a tag to compare`, `选择一个标签进行比对`],
  [`Find a tag`, `输入标签名搜索`],
  [`Actions`, `GitHub 自动化流程`],
  [`You unlocked new Achievements with private contributions! Show them off by including private contributions in your Profile in settings.`,
   `你通过私有贡献解锁了新成就！在设置中将私有贡献包含到个人资料里，即可展示这些成就。`],
  [`Stars`, `星标`],
  [`Type:all`, `类型：全部`],
  [`Create your first list`, `创建你的第一个列表`],
  [`Lists make it easier to organize and curate repositories that you have starred.`, `列表让你更轻松地整理和精选已收藏的仓库。`],
  [`Search`, `搜索`],
  [`Search stars`, `搜索星标`],
  [`Forks`, `分叉`],
  [``, ``],
